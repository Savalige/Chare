...
namespace API.Migrations
{
    ...
    [Migration("20221012090720_testingagain2")]
    partial class testingagain2
    {
            ...
            modelBuilder.Entity("API.Models.ApprovedPassengerModel", b =>
                {
                    ...
                    b.HasOne("API.Models.TripModel", null)
                        .WithMany("Tr_ApprovedPassengers")
                        .HasForeignKey("TripModelTr_Id");
